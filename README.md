...
The weirdest Project for kittens, Creators and even aliens (web-browser default page). 
...
| **shifterX**              | A tool for generating *.xls tables or JSON files.                 | [Live Demo](https://kostassliazas.github.io/project-kitten/tools/shifter)       |
...
| **Questions game**        | A game for answering customizable sets of questions.                  | [Live Demo](https://kostassliazas.github.io/project-kitten/games/questionnaire)     |
