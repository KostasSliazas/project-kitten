...
(function (w, d) {
  ...
  // variables
  const G = {
    url: 'https://opentdb.com/api.php?amount=10', // game questions data source
    secnds: 25, // time for questions to answer
  ...
  const defaultData = {
    ...
    results: [
      ...
      },
      {
        ...
        incorrect_answers: ['Samsung', 'Microsoft', 'Sony'],
      },
      {
        type: 'multiple',
        difficulty: 'hard',
      ...
      },
      {
        ...
        incorrect_answers: ['Valve', 'Epic Games', 'Ubisoft'],
      },
      {
        type: 'multiple',
        difficulty: 'easy',
      ...
      },
      {
        ...
        incorrect_answers: ['HyperText Markdown Language', 'HighText Machine Language', 'Home Tool Markup Language'],
      },
      {
        type: 'multiple',
        difficulty: 'hard',
        category: 'Space',
        question: 'Which moon of Saturn is larger than the planet Mercury?',
        correct_answer: 'Titan',
        incorrect_answers: ['Europa', 'Io', 'Triton'],
      },
      {
        type: 'multiple',
        difficulty: 'easy',
  ...
  function getData() {
    w.fetch(G.url)
      ...
      .catch(error => {
        dataLoaded(defaultData);
        G.elems.star.innerText = 'Error: ' + error;
        G.elems.starBtn.innerText = 'Retry with default';
  ...
  const countdown = secnds => {
    (function inner() {
      G.elems.seco.innerText = secnds;
      clearTimeout(G.tim);
      if (--secnds >= 0) {
