...
(function (w, d) {
  ...
  const blockDefaults = 'width:960px;height:48px;left:192px;top:0px;,width:492px;height:48px;left:192px;top:48px;,width:156px;height:48px;left:192px;top:144px;,width:156px;height:48px;left:192px;top:216px;,width:120px;height:48px;left:1032px;top:48px;,width:168px;height:96px;left:348px;top:96px;,width:168px;height:72px;left:516px;top:96px;,width:168px;height:168px;left:516px;top:168px;,width:168px;height:144px;left:516px;top:336px;,width:168px;height:96px;left:516px;top:480px;,width:168px;height:144px;left:516px;top:576px;,width:156px;height:72px;left:192px;top:120px;,width:156px;height:252px;left:192px;top:264px;,width:168px;height:96px;left:516px;top:720px;,width:168px;height:624px;left:348px;top:192px;,width:120px;height:48px;left:684px;top:48px;,width:156px;height:48px;left:192px;top:168px;,width:144px;height:48px;left:804px;top:48px;,width:156px;height:108px;left:192px;top:96px;,width:156px;height:300px;left:192px;top:516px;,width:960px;height:48px;left:192px;top:24px;,width:168px;height:84px;left:192px;top:72px;,width:324px;height:756px;left:360px;top:72px;,width:144px;height:96px;left:684px;top:96px;,width:144px;height:240px;left:684px;top:336px;,width:144px;height:48px;left:684px;top:192px;,width:156px;height:384px;left:996px;top:432px;,width:156px;height:168px;left:996px;top:264px;,width:168px;height:72px;left:828px;top:264px;,width:168px;height:480px;left:828px;top:336px;,width:156px;height:168px;left:996px;top:96px;,width:168px;height:96px;left:828px;top:168px;,width:144px;height:240px;left:684px;top:576px;,width:168px;height:72px;left:828px;top:96px;,width:144px;height:96px;left:684px;top:240px;,width:84px;height:48px;left:948px;top:48px;,width:;height:;left:996px;top:0px';
  ...
  function isBigger(el1, el2) {
    if (!el1 || !el2) return false;
    return el1.offsetWidth > el2.offsetWidth || el1.offsetHeight > el2.offsetHeight;
  }
  ...
  function stats(data) {
    ...
    const tempTitle = d.querySelector('#temp-title');
    const now = new Date();
    ...
    main.addEventListener('mouseover', function (e) {
      ...
      if (targetElement.tagName === 'path') {
        ...
        tempTitle.title = stats.innerText = statsText;
      }
    });
  ...
  const longNames = ['peace on earth', 'inner peace', 'cool dudes', 'sunshine', 'someday', 'everything fine', 'respect'];
  ...
  function rootClick(e) {
    ...
    const emailLink = clickedElement.closest('#email-link');
    ...
    if (searchInputs.includes(target)) {
      const inputElement = d.getElementById(target);
      if (inputElement) {
  ...
  function centerElements() {
    ...
    const elements = d.querySelectorAll('.movable');
  ...
  function btn(e) {
    ...
    const isIgnoredElement = !target.matches('input') || target.classList.contains('calculator__button--sound') || target.classList.contains('calculator__screen');
